...
public class CorpseManager implements InventoryManager {
    private Character player;
    private Corpse corpse;

    public CorpseManager(Character player, Corpse corpse) {
        this.player = player;
        this.corpse = corpse;
    }
    ...
    public ArrayList<String> getChoices() {
        ...
        choices.add("take item# - takes an item from the corpse");
        choices.add("use bag# item# - uses an item in the inventory");
        choices.add("destroy bag# item# - destroys an item in the inventory");
        choices.add("open (inventory/corpse) - view inventory and corpse contents");
    ...
    public ArrayList<String> openInventories() {
        ...
        inventories.add(this.corpse.openInventory());
