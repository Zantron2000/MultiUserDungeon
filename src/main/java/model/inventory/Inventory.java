...
public class Inventory {
    ...
    private final Bag[] bags; // The list of bags in the inventory
    ...
    /**
     * Attempts to remove an item from the user's inventory
     * 
    ...
    public ArrayList<Item> emptyInventory() {
        ...
        for(Bag bag : this.bags) {
            if(bag != null) {
                for(int i = 0; i < bag.getTotalSpace(); i++) {
     ...
     * @return null as the bag isn't needed outside the inventory
     */
