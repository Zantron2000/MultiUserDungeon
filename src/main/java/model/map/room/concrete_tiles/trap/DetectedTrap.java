...
public class DetectedTrap implements TrapCondition  {
    ...
    private final static String SYMBOL = "-"; // The symbol representation of a detected trap
    private final static String DESCRIPTION = "There is an armed trap on the ground here. "; // The description of the detected trap
    private final static boolean IS_ARMED = true; // The default armed condition for a detected trap
    private final static boolean IS_DETECTED = true; // The default detected condition for a detected trap
