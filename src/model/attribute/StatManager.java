...
public class StatManager {
    ...
    private ArrayList<Stat> flatBuffs; // List of all flat buffs
    private ArrayList<Stat> scalarBuffs; // List of all scalar buffs
    private int maxHealth; // The max health 
    private int health; // The current heatlh
    ...
    private int getFlatAttack() {
        ...
        for(int i = 0; i < flatBuffs.size(); i++) {
            attack += flatBuffs.get(i).getAttack();
        }
    ...
    /**
     * Gets the total scalar attack buffs using multiplicitive 
     * rules for stats
     * 
    ...
    private int getScalarAttack() {
        ...
        for(int i = 0; i < scalarBuffs.size(); i++) {
            attack *= scalarBuffs.get(i).getAttack();
        }
    ...
    private int getFlatDefense() {
        ...
        for(int i = 0; i < flatBuffs.size(); i++) {
            defense += flatBuffs.get(i).getDefense();
        }
    ...
    /**
     * Gets the total scalar defense buffs using multiplicitive 
     * rules for stats
     * 
    ...
    private int getScalarDefense() {
        ...
        for(int i = 0; i < scalarBuffs.size(); i++) {
            defense *= scalarBuffs.get(i).getDefense();
        }
