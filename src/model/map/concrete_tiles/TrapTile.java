...
import model.map.concrete_tiles.trap.*;
...
public class TrapTile extends MovableTile {
    ...
    /**
     * A tester function for attempt detect to negate randomness
     * 
    ...
    /**
     * A tester function for attempt disarm to negate randomness
     * 
