...
public class DisarmedTrap implements TrapCondition {
    private static int BASE_ATTACK = 0; // The default attack value of a trap
    private static String SYMBOL = "V"; // The symbol representation of a hidden trap
    private static String DESCRIPTION = "There is a disarmed trap on the ground here. "; // The description of the detected trap
    private static boolean IS_ARMED = false; // The default armed condition for a hidden trap
    private static boolean IS_DETECTED = true; // The default detected condition for a hidden trap
