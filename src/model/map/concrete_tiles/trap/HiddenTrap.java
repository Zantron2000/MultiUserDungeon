...
public class HiddenTrap implements TrapCondition {
    ...
    private static String SYMBOL = " "; // The symbol representation of a hidden trap
    private static String DESCRIPTION = ""; // The description of the hidden trap
    private static boolean IS_ARMED = true; // The default armed condition for a hidden trap
    private static boolean IS_DETECTED = false; // The default detected condition for a hidden trap
